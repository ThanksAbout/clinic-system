                            ...
                            <div class="owl-carousel reviews-carousel">
                                <?php foreach ($reviews as $review): ?>
                                    <figure class="reviews-thumb d-flex flex-wrap align-items-center rounded"
                                            style="background-color: #f2f2f2; padding: 20px; color: #000;">
                                        <div class="reviews-stars w-100 mb-2">
                                            <?php
                                        ...
                                        <p class="text-primary d-block mb-1 w-100"><strong>Patient Feedback</strong></p>
                                        <p><?= $review['comment'] ?></p>

                                        <figcaption class="mt-3 w-100">
                                            <strong><?= $review['full_name'] ?></strong><br>
